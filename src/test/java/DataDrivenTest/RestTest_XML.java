...
import DataDriven.Data_Driven_Xml_Excel;
...
*/
 ...
 @DataProvider (name = "data")
    public Object[][] data()  throws IOException, InvalidFormatException {
        Data_Driven_Xml_Excel obj=new Data_Driven_Xml_Excel();
        return obj.read_from_excel("ExcelSheet/paraBank-Excel-Sheet.xlsx","Sheet1");
    }
